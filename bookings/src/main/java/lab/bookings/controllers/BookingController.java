...
public class BookingController {
    ...
    public String deleteBooking(@RequestParam Long bookingId, RedirectAttributes redirectAttributes) {
        try {
            ...
            redirectAttributes.addFlashAttribute("message", "Rezerwacja została pomyślnie usunięta.");
        } catch (Exception e) {
            redirectAttributes.addFlashAttribute("error", "Nie udało się usunąć rezerwacji.");
        }
